...
- [✓/✗ CC-priors-identifiability S6 · when **a factor/loading sign is non-identified** → constraining **ONE ](../../recs/CC-priors-identifiability/S6.md) `0.85`
...
- [✓/✗ CC-priors-identifiability S7 · when **a correlation's sign is encoded through `abs()` / squaring / a ](../../recs/CC-priors-identifiability/S7.md) `0.85`
