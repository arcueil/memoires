...
- [✓ CC-geometry-sampling TD4 · when **Cauchy tail quantiles matter** → raising max_treedepth to 20 to](../../recs/CC-geometry-sampling/TD4.md) `0.81`
- [✗ time-series-state-space P1 · for a **fine-grid discretized Markov chain** (e.g. Brownian motion, N≈](../../recs/time-series-state-space/P1.md) `0.80`
