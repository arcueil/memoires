...
- [✓ gaussian-process HP7 · for **GP hyperparameter identifiability** → inspecting the **2-D joint](../../recs/gaussian-process/HP7.md) `0.82`
...
- [✗ gaussian-process HP6 · for **GP hyperparameter identifiability** → reading only the **margina](../../recs/gaussian-process/HP6.md) `0.81`
