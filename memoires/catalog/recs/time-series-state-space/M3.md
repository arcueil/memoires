...
- [CC-priors-identifiability C2 · Likelihood symmetries create structural, data-invariant multimodality ](../../claims/CC-priors-identifiability/C2.md) `0.86`
- [✓ latent-factor E1 · for a suspected **multimodal / non-identified** latent-factor posterio](../../recs/latent-factor/E1.md) `0.85`
- [✓ ode-dynamical M2 · for **genuine multimodality** → **characterize each mode with posterio](../../recs/ode-dynamical/M2.md) `0.85`
- [✓ CC-priors-identifiability S2 · when **the modes are symmetry-equivalent** (permutation-invariant esti](../../recs/CC-priors-identifiability/S2.md) `0.84`
