...
- [✓ CC-geometry-sampling DV3 · when divergences **cluster at small τ / an abrupt boundary** in the no](../../recs/CC-geometry-sampling/DV3.md) `0.83`
- [✓ CC-geometry-sampling DV2 · when divergences appear → pairs-plotting the offending parameters and ](../../recs/CC-geometry-sampling/DV2.md) `0.83`
- [CC-geometry-sampling C2 · Divergences are read by *location* and *origin*, not count — and their](../../claims/CC-geometry-sampling/C2.md) `0.82`
