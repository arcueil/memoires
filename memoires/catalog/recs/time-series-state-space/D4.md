...
- [✗ hierarchical-multilevel D4 · for **residual hierarchical decompositions** (θ_l = θ + δ_l) → **count](../../recs/hierarchical-multilevel/D4.md) `0.79`
- [✗ CC-geometry-sampling IM1 · when computing **sparse log-determinant gradients in float32** → it do](../../recs/CC-geometry-sampling/IM1.md) `0.79`
