...
- [✗ CC-geometry-sampling RP4 · when using **Stan's offset/multiplier sugar with a σ that can reach 0*](../../recs/CC-geometry-sampling/RP4.md) `0.81`
- [CC-geometry-sampling C5 · Likelihood-induced funnels have *no reparameterization analogue* — non](../../claims/CC-geometry-sampling/C5.md) `0.81`
