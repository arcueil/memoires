...
- [✓ ode-dynamical M2 · for **genuine multimodality** → **characterize each mode with posterio](../../recs/ode-dynamical/M2.md) `0.80`
- [✗ gaussian-process A1 · for an **additive / multi-component signal decomposition** (multi-scal](../../recs/gaussian-process/A1.md) `0.80`
- [✓ ode-dynamical M4 · for a **periodic dynamical model with period-induced multimodality** →](../../recs/ode-dynamical/M4.md) `0.80`
