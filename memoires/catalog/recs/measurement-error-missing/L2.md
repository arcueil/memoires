...
- [✗ CC-convergence-diagnostics E4 · when you want a probability *density* from samples via KDE → does **NO](../../recs/CC-convergence-diagnostics/E4.md) `0.80`
- [✓ CC-convergence-diagnostics B4 · when detecting metastability under a compute budget → prefer more **ov](../../recs/CC-convergence-diagnostics/B4.md) `0.80`
