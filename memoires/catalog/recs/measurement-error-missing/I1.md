...
- [✓/✗ mixture Z3 · for a **theoretical quantity observed through a measurement process** ](../../recs/mixture/Z3.md) `0.81`
- [✗ ode-dynamical Q3 · for **validating a prior** → checking **prior-predictive consequences ](../../recs/ode-dynamical/Q3.md) `0.79`
- [✓ regression TB1 · for a **limited / corner outcome piled at a bound** (expenditure, hour](../../recs/regression/TB1.md) `0.79`
