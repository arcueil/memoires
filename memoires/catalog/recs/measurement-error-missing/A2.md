...
- [✗ regression CF5 · for a **randomized/designed experiment with dropout/censoring** correl](../../recs/regression/CF5.md) `0.88`
- [✗ CC-priors-identifiability P3 · when **you assume randomization alone suppresses confounding** → does ](../../recs/CC-priors-identifiability/P3.md) `0.88`
