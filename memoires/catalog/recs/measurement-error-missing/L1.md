...
- [✗ CC-convergence-diagnostics F3 · when a top-line "largest R-hat is NA, chains have not mixed" / "Bulk/T](../../recs/CC-convergence-diagnostics/F3.md) `0.81`
- [✗ regression LS2 · for **two outcomes with unequal counts / non-Gaussian families** → a *](../../recs/regression/LS2.md) `0.80`
- [✓/✗ mixture Z4 · for **marginalizing a sum of independent binomial latent counts agains](../../recs/mixture/Z4.md) `0.79`
