...
- [✗ gaussian-process SP1 · for a **Bayesian penalized-spline / GAM smooth** → reasoning about glo](../../recs/gaussian-process/SP1.md) `0.96`
- [✓ gaussian-process EB2 · for **checking a GP/spline prior** → running a **prior-predictive chec](../../recs/gaussian-process/EB2.md) `0.85`
- [✗ gaussian-process HP13 · for a **non-centered spline/GP term** flagged by a **power-scaling pri](../../recs/gaussian-process/HP13.md) `0.84`
- [✓ gaussian-process SP2 · for a **monotone/shape-constrained smooth** wanted from a linear splin](../../recs/gaussian-process/SP2.md) `0.82`
