...
- [✗ latent-factor B1 · for a model where an **observable = sum of latent components**, each w](../../recs/latent-factor/B1.md) `0.88`
- [latent-factor C2 · When an observable is a many-to-one (additive) combination of latent c](../../claims/latent-factor/C2.md) `0.88`
- [✓ latent-factor B2 · for such an **additive-component** model → adding **structure that tie](../../recs/latent-factor/B2.md) `0.80`
- [time-series-state-space C6 · A structural time series decomposes additively into interpretable late](../../claims/time-series-state-space/C6.md) `0.79`
