...
- [✗ CC-model-evaluation A5 · when **prediction targets fall outside the training covariate support*](../../recs/CC-model-evaluation/A5.md) `0.96`
- [✗ CC-model-evaluation A4 · when a **conditional-only retrodictive check passes** (covariates fixe](../../recs/CC-model-evaluation/A4.md) `0.87`
...
- [✓ CC-model-evaluation A6 · when you **suspect extrapolation** → **visually inspecting train-vs-ta](../../recs/CC-model-evaluation/A6.md) `0.84`
