...
- [✗ CC-geometry-sampling ZD1 · when **zero divergences in an underdetermined regression** (N<M) → con](../../recs/CC-geometry-sampling/ZD1.md) `0.85`
- [✓ CC-geometry-sampling TD1 · when tree-depth saturates **without divergences and with normal E-FMI*](../../recs/CC-geometry-sampling/TD1.md) `0.84`
- [CC-geometry-sampling C3 · The diagnostics are distinct fingerprints, not interchangeable — tree-](../../claims/CC-geometry-sampling/C3.md) `0.84`
- [✗ CC-geometry-sampling SP2 · when a **horseshoe shows E-BFMI collapse + divergences** → raising ada](../../recs/CC-geometry-sampling/SP2.md) `0.83`
