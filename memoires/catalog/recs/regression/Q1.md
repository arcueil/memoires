...
- [✓ CC-geometry-sampling LF2 · when covariates are **near-collinear** (x, x² for uncentered positive ](../../recs/CC-geometry-sampling/LF2.md) `0.94`
- [✗ CC-geometry-sampling LF3 · when covariates are **left uncentered before a polynomial/nonlinear ex](../../recs/CC-geometry-sampling/LF3.md) `0.91`
...
- [✗ hierarchical-multilevel P9 · for an **underdetermined / rank-deficient Gaussian regression** → NCP ](../../recs/hierarchical-multilevel/P9.md) `0.83`
