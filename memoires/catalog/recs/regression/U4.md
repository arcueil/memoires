...
- [✓ CC-priors-identifiability W3 · when **the M>N regression is genuinely sparse** → a **Finnish horsesho](../../recs/CC-priors-identifiability/W3.md) `0.92`
...
- [✓ sparse-shrinkage S1 · for a **horseshoe / Finnish horseshoe** → setting **tau_0 = (m_0/(M − ](../../recs/sparse-shrinkage/S1.md) `0.86`
