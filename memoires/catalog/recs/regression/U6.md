...
- [✗ CC-geometry-sampling ZD1 · when **zero divergences in an underdetermined regression** (N<M) → con](../../recs/CC-geometry-sampling/ZD1.md) `0.93`
- [CC-geometry-sampling C2 · Divergences are read by *location* and *origin*, not count — and their](../../claims/CC-geometry-sampling/C2.md) `0.86`
