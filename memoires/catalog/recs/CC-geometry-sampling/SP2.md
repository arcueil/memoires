...
- [✗ sparse-shrinkage D1 · for a **horseshoe funnel** → **raising adapt_delta / max_treedepth to ](../../recs/sparse-shrinkage/D1.md) `0.92`
- [✓ sparse-shrinkage D5 · for **sparsity samplers** → reading **E-BFMI collapse as a geometry si](../../recs/sparse-shrinkage/D5.md) `0.87`
- [sparse-shrinkage C4 · Sparsity pathology is intrinsic funnel geometry — diagnostics are sign](../../claims/sparse-shrinkage/C4.md) `0.86`
