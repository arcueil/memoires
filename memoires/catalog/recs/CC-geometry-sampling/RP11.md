...
- [✗ ode-dynamical R1 · for inferring **both gravity g and drag k from light-ball data alone**](../../recs/ode-dynamical/R1.md) `0.79`
...
- [✗ gaussian-process HP12 · for a **Matérn GP** → **inferring the smoothness ν jointly** does **NO](../../recs/gaussian-process/HP12.md) `0.78`
