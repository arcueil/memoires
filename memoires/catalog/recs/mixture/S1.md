...
- [✓ sparse-shrinkage G2 · for a **mixture-prior / horseshoe** → choosing **CP vs NCP per-paramet](../../recs/sparse-shrinkage/G2.md) `0.90`
- [✓ sparse-shrinkage P5 · for **prediction** → a **two-scale prior** (mixture of two normals / r](../../recs/sparse-shrinkage/P5.md) `0.85`
