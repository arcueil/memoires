...
- [✗ measurement-error-missing B1 · for **count/spectral data observed through a non-trivial measurement p](../../recs/measurement-error-missing/B1.md) `0.90`
- [measurement-error-missing C1 · The observational model is the theoretical model convolved with the me](../../claims/measurement-error-missing/C1.md) `0.89`
- [✓ measurement-error-missing B2 · for such data → building the observational model as **theoretical-spec](../../recs/measurement-error-missing/B2.md) `0.87`
- [✓ measurement-error-missing A2 · for that designed experiment → **explicitly modeling the censoring/sel](../../recs/measurement-error-missing/A2.md) `0.86`
