...
- [✓ regression VS2 · for **selecting a smaller predictor set** → fit one good **reference m](../../recs/regression/VS2.md) `0.98`
- [✗ regression VS1 · for **selecting a smaller predictor set** → refitting each candidate s](../../recs/regression/VS1.md) `0.85`
