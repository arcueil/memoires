...
- [✗ CC-geometry-sampling SP4 · when using the **Laplace prior** (Bayesian LASSO) for simultaneous spa](../../recs/CC-geometry-sampling/SP4.md) `0.89`
...
- [✓ CC-priors-identifiability W4 · when **you want a free diagnostic for prior misspecification in sparse](../../recs/CC-priors-identifiability/W4.md) `0.82`
