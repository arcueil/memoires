...
- [✗ regression GP3 · for **spatially-autocorrelated regression covariates** → ignoring cova](../../recs/regression/GP3.md) `0.89`
- [spatial-areal C5 · Spatial autocorrelation is not only an outcome nuisance — SA in a *cov](../../claims/spatial-areal/C5.md) `0.89`
- [✗ spatial-areal A1 · for a **regression/GLM on spatially-indexed data where a covariate is ](../../recs/spatial-areal/A1.md) `0.87`
