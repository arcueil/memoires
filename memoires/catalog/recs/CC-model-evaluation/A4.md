...
- [✗ regression CF4 · for **detecting** confounding / marginal-covariate-model failure → a *](../../recs/regression/CF4.md) `0.90`
...
- [⚪ regression CF7 · for **compensating** conditional-only models under confounding → **pro](../../recs/regression/CF7.md) `0.81`
