...
- [✗ regression T5 · for **extrapolation to non-overlapping covariate regions** → relying o](../../recs/regression/T5.md) `0.96`
...
- [regression C2 · Linear (and polynomial) regression is a *local Taylor approximation* —](../../claims/regression/C2.md) `0.84`
