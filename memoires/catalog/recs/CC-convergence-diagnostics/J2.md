...
- [✗ CC-geometry-sampling ST5 · when using a **Pathfinder / reverse-KL (ELBO) VI fit as the POSTERIOR*](../../recs/CC-geometry-sampling/ST5.md) `0.80`
- [✗ CC-geometry-sampling EF2 · when **E-FMI passes** → concluding no posterior degeneracy does **NOT*](../../recs/CC-geometry-sampling/EF2.md) `0.79`
