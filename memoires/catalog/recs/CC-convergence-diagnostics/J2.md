...
- [✗ latent-factor D4 · for a marginalized latent-Gaussian model → assuming **marginalization ](../../recs/latent-factor/D4.md) `0.78`
- [✓ CC-geometry-sampling ST6 · when SVI on a **Bayesian NN/RNN gives a NaN ELBO at the first iteratio](../../recs/CC-geometry-sampling/ST6.md) `0.77`
- [✓ CC-geometry-sampling VI1 · when you want faster, more stable VI convergence than stochastic ADVI ](../../recs/CC-geometry-sampling/VI1.md) `0.77`
- [✗ CC-geometry-sampling EF1 · when **E-FMI passes but the funnel is localized** (per-latent-pair) → ](../../recs/CC-geometry-sampling/EF1.md) `0.77`
