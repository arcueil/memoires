...
- [✗ CC-geometry-sampling SC1 · when a fit **stalls or runs pathologically slowly** → parallelization ](../../recs/CC-geometry-sampling/SC1.md) `0.78`
- [✓ CC-geometry-sampling EF3 · when a **single global scale funnels but divergences lag** → treating ](../../recs/CC-geometry-sampling/EF3.md) `0.78`
