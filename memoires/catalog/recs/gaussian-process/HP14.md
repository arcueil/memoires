...
- [sparse-shrinkage C7 · R2D2 puts the prior on variance explained (R²) — the total-variance bu](../../claims/sparse-shrinkage/C7.md) `0.86`
- [✓ sparse-shrinkage P8 · for **budgeting the prior on TOTAL model variance / variance explained](../../recs/sparse-shrinkage/P8.md) `0.84`
