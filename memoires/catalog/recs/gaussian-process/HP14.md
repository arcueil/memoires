...
- [sparse-shrinkage C7 · R2D2 puts the prior on variance explained (R²) — the total-variance bu](../../claims/sparse-shrinkage/C7.md) `0.85`
...
- [✗ CC-priors-identifiability G2 · when **you judge GP identifiability from the marginal ρ and σ posterio](../../recs/CC-priors-identifiability/G2.md) `0.84`
