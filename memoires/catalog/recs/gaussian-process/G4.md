...
- [✓ regression GP1 · for a **latent-Gaussian (GP) regression with divergences at small σ** ](../../recs/regression/GP1.md) `0.96`
...
- [✗ CC-geometry-sampling GP4 · when **GP divergences localize at small σ** → a zero-avoiding prior on](../../recs/CC-geometry-sampling/GP4.md) `0.90`
