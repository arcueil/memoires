...
- [spatial-areal C1 · Precision, not covariance, is the working representation for structure](../../claims/spatial-areal/C1.md) `0.78`
- [✗ spatial-areal N2 · for a **spatial GP kernel with a sqrt distance on the diagonal** (i==j](../../recs/spatial-areal/N2.md) `0.77`
- [✓ spatial-areal K2 · for wanting a **fast RBF-like GP** → use an **inducing-point sparse GP](../../recs/spatial-areal/K2.md) `0.77`
- [✓ spatial-areal S1 · for a latent-Gaussian spatial model y = Au + ε, u ~ N(0, Q(θ)⁻¹) with ](../../recs/spatial-areal/S1.md) `0.77`
