...
*[→ full entry](../claims/mixture/C1.md)*
...
*[→ full entry](../claims/mixture/C3.md)*
...
*[→ full entry](../claims/mixture/C4.md)*
...
*[→ full entry](../claims/mixture/C5.md)*
...
*[→ full entry](../claims/mixture/C6.md)*
...
**✗ D1** · for a **degenerate mixture** (identical component family, exchangeable priors) → a **single *[→ entry](../recs/mixture/D1.md)*
...
**✗ D2** · for a **degenerate mixture** → the **standard HMC diagnostics** (divergences, E-BFMI, *[→ entry](../recs/mixture/D2.md)*
...
**✓ D3** · for a **degenerate mixture** → **multiple chains from dispersed inits + split-R̂ + *[→ entry](../recs/mixture/D3.md)*
...
**✓ B1** · for a degenerate mixture with **scalar component params + a permutation-invariant estimand** *[→ entry](../recs/mixture/B1.md)*
...
**✗ B2** · for a degenerate mixture → **running longer / pure tuning** (adapt_delta→0.999, more *[→ entry](../recs/mixture/B2.md)*
...
**✓/✗ B3** · for a degenerate mixture with **asymmetric / non-exchangeable mean priors** → the priors *[→ entry](../recs/mixture/B3.md)*
...
**✗ O1** · for **overlapping components** (separation < ~1–2 σ) → the **ordering constraint** does *[→ entry](../recs/mixture/O1.md)*
...
**✓ O3** · for **overlapping components** → a **repulsive prior** (penalizing μ₁ ≈ μ₂) is the only *[→ entry](../recs/mixture/O3.md)*
...
**✗ O4** · for **overlapping components** → trying to **infer the mixture weight θ from the data** does *[→ entry](../recs/mixture/O4.md)*
...
**✓ M1** · for a mixture under **HMC/NUTS** → **marginalize the discrete assignments z analytically** *[→ entry](../recs/mixture/M1.md)*
...
**✗ M2** · for **discrete latent indices in mean-field SVI** → putting the discrete latent as a *[→ entry](../recs/mixture/M2.md)*
...
**✓ M3** · for a **marginalized model** → recover z **post-hoc as the data-conditioned membership *[→ entry](../recs/mixture/M3.md)*
...
**✗ M4** · for **benchmarking a marginalized/enumerated sampler against a discrete-Gibbs sampler** on a *[→ entry](../recs/mixture/M4.md)*
...
**✓ Z1** · for **zero-inflation over a continuous baseline** → **decompose exactly into an independent *[→ entry](../recs/mixture/Z1.md)*
...
**✗ Z2** · for **hurdle / zero-inflated models** → reading **`fitted`-type output** (conditional mean *[→ entry](../recs/mixture/Z2.md)*
...
**✓/✗ Z3** · for a **theoretical quantity observed through a measurement process** → building the *[→ entry](../recs/mixture/Z3.md)*
...
**✓/✗ Z4** · for **marginalizing a sum of independent binomial latent counts against an observed *[→ entry](../recs/mixture/Z4.md)*
...
**✗ S1** · for choosing **CP vs NCP per parameter in a mixture / horseshoe prior** → using the **N_k *[→ entry](../recs/mixture/S1.md)*
...
**✓ S2** · for a **mixture / horseshoe prior** → choose **CP/NCP per parameter by where its likelihood *[→ entry](../recs/mixture/S2.md)*
...
**✗ S3** · for a **two-component normal mixture prior** (outer_τ ≫ inner_τ) → reading **R̂ > 1.1 on *[→ entry](../recs/mixture/S3.md)*
...
**✗ N1** · for a **Bayesian neural network** → treating the **weight posterior as a tractable HMC/NUTS *[→ entry](../recs/mixture/N1.md)*
...
**✗ I1** · for a **Gaussian-mixture / quadratic-form pseudo-likelihood in HMC** → treating it as a *[→ entry](../recs/mixture/I1.md)*
