...
*[→ full entry](../claims/measurement-error-missing/C1.md)*
...
*[→ full entry](../claims/measurement-error-missing/C2.md)*
...
*[→ full entry](../claims/measurement-error-missing/C3.md)*
...
*[→ full entry](../claims/measurement-error-missing/C4.md)*
...
*[→ full entry](../claims/measurement-error-missing/C5.md)*
...
*[→ full entry](../claims/measurement-error-missing/C6.md)*
...
**✗ A1** · for a randomized/designed experiment with **dropout, censoring, or non-compliance *[→ entry](../recs/measurement-error-missing/A1.md)*
...
**✓ A2** · for that designed experiment → **explicitly modeling the censoring/selection mechanism** *[→ entry](../recs/measurement-error-missing/A2.md)*
...
**✗ A3** · for population-mean estimation under **covariate-dependent sampling where ξ_j and μ_j are *[→ entry](../recs/measurement-error-missing/A3.md)*
...
**✓ A4** · for that covariate-dependent-sampling problem → **modeling the randomization mechanism and *[→ entry](../recs/measurement-error-missing/A4.md)*
...
**✗ B1** · for **count/spectral data observed through a non-trivial measurement process** → fitting *[→ entry](../recs/measurement-error-missing/B1.md)*
...
**✓ B2** · for such data → building the observational model as **theoretical-spectrum-integrated-over- *[→ entry](../recs/measurement-error-missing/B2.md)*
...
**✗ C1** · for **pre/post (T1/T2) repeated measurements** → entering the baseline **T1 as a right- *[→ entry](../recs/measurement-error-missing/C1.md)*
...
**✓ C2** · for pre/post repeated measures → modeling **both timepoints as the response in long *[→ entry](../recs/measurement-error-missing/C2.md)*
...
**✗ D1** · for a **missing RESPONSE** → imputing it and re-fitting the model on the imputed values *[→ entry](../recs/measurement-error-missing/D1.md)*
does **NOT** work.
...
**✓ D2** · for a **missing COVARIATE** → imputing it inside a single joint fit *[→ entry](../recs/measurement-error-missing/D2.md)*
...
**✗ E1** · for **missing entries in an array-valued observed variable under HMC/NUTS where you don't *[→ entry](../recs/measurement-error-missing/E1.md)*
...
**✓ E2** · for that case → **masking the log-PROBABILITY of the missing entries** (`logp(...)*mask`, *[→ entry](../recs/measurement-error-missing/E2.md)*
...
**✓/✗ F1** · for a **bivariate (or joint) model where one component can go missing** → choosing the *[→ entry](../recs/measurement-error-missing/F1.md)*
...
**✗ G1** · for a model **labeled a "mixture" whose component weights are actually KNOWN** → treating *[→ entry](../recs/measurement-error-missing/G1.md)*
...
**✓ G2** · for assessing whether a **convolution/compound model's component parameters are *[→ entry](../recs/measurement-error-missing/G2.md)*
...
**✗ H1** · for a model with **missing/latent DISCRETE values under HMC** → accumulating the sum over *[→ entry](../recs/measurement-error-missing/H1.md)*
...
**✓ H2** · for a **missing discrete covariate** → **marginalize it out** (condition on observed *[→ entry](../recs/measurement-error-missing/H2.md)*
...
**✓ I1** · for **interval/block-censored discrete observations** (periodic inspection detecting a *[→ entry](../recs/measurement-error-missing/I1.md)*
...
**✗ I2** · for **turning a solved censored inference into an action** → using a fixed **percentile *[→ entry](../recs/measurement-error-missing/I2.md)*
...
**✗ J1** · for a **misclassification / annotator (label measurement-error) model** → the naive *[→ entry](../recs/measurement-error-missing/J1.md)*
...
**✓ J2** · for the **misclassification-row simplex under HMC** → reparameterize the rows onto the *[→ entry](../recs/measurement-error-missing/J2.md)*
...
**✗ K1** · for a **latent/mixture measurement model that diverges** → **pure sampler tuning** *[→ entry](../recs/measurement-error-missing/K1.md)*
...
**✓ K2** · for that diverging mixture/latent fit → **non-center the components** (z~std_normal, *[→ entry](../recs/measurement-error-missing/K2.md)*
...
**✓ K3** · for such a fit → **diagnose the geometry first** — pairs/scatter of (μ1 vs μ2, σ vs *[→ entry](../recs/measurement-error-missing/K3.md)*
...
**✓ K4** · for a mixture measurement model with **label-switching / prior-induced pathology** → *[→ entry](../recs/measurement-error-missing/K4.md)*
...
**✗ L1** · for a **custom count likelihood in brms/Stan on large-count data** → the default integer- *[→ entry](../recs/measurement-error-missing/L1.md)*
...
**✓ L2** · for such large-count overflow → **re-express the count likelihood on REAL outcomes** via a *[→ entry](../recs/measurement-error-missing/L2.md)*
...
**✓ M1** · for **limited/corner outcomes piled at a bound** (expenditure, hours worked, demand *[→ entry](../recs/measurement-error-missing/M1.md)*
...
**✓ N1** · for **outliers you want to downweight without explicitly flagging them** (implicit *[→ entry](../recs/measurement-error-missing/N1.md)*
