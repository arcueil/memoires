...
- [mixture C6 · A mixture can be a *prior*, not a likelihood — then the rule is per-co](../../claims/mixture/C6.md) `0.76`
- [hierarchical-multilevel C3 · With few groups the pathology moves up to the population scale τ, whos](../../claims/hierarchical-multilevel/C3.md) `0.75`
- [mixture C3 · The two fixes divide by exactness — ordering constraints are provably ](../../claims/mixture/C3.md) `0.74`
- [✓ hierarchical-multilevel B2 · for a hierarchical **scale parameter** → **weakly-informative bounded ](../../recs/hierarchical-multilevel/B2.md) `0.74`
