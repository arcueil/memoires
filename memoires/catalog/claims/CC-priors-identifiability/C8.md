...
- [✓ hierarchical-multilevel B2 · for a hierarchical **scale parameter** → **weakly-informative bounded ](../../recs/hierarchical-multilevel/B2.md) `0.75`
- [✗ regression PR1 · for **any regression** → **flat/improper** or **diffuse-but-proper** p](../../recs/regression/PR1.md) `0.74`
