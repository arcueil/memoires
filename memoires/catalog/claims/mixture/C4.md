...
- [✗ CC-geometry-sampling DM3 · when **mixture components overlap** (<~1.5–2 σ) → the ordering constra](../../recs/CC-geometry-sampling/DM3.md) `0.81`
- [✓ CC-geometry-sampling DM2 · when **mixture components are well-separated** (>~2–3 σ) → an ordering](../../recs/CC-geometry-sampling/DM2.md) `0.78`
- [✗ CC-priors-identifiability W6 · when **mixture components overlap substantially** → the data do **NOT*](../../recs/CC-priors-identifiability/W6.md) `0.78`
