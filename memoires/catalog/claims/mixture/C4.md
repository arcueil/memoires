...
- [✗ CC-geometry-sampling DM3 · when **mixture components overlap** (<~1.5–2 σ) → the ordering constra](../../recs/CC-geometry-sampling/DM3.md) `0.80`
- [✗ hierarchical-multilevel D5 · for **cross-classified overlapping** designs with higher-order interac](../../recs/hierarchical-multilevel/D5.md) `0.77`
