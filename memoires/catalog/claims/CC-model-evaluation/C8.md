...
- [✓ sparse-shrinkage W1 · for **iterative sparse-model development** → **nested model expansion*](../../recs/sparse-shrinkage/W1.md) `0.84`
- [sparse-shrinkage C5 · Build sparse models by nested expansion under valid warmup — fix geome](../../claims/sparse-shrinkage/C5.md) `0.83`
- [✗ ode-dynamical Q5 · for **iterative model building** → treating **post-hoc model selection](../../recs/ode-dynamical/Q5.md) `0.80`
- [✗ sparse-shrinkage W2 · for **iterative sparse-model development** → **replacing the model who](../../recs/sparse-shrinkage/W2.md) `0.80`
