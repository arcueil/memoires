...
- [✓ gaussian-process S4 · for a **sparse-precision latent-Gaussian model** → **parameterizing vi](../../recs/gaussian-process/S4.md) `0.91`
...
- [gaussian-process C4 · Sparsity is not a numerical trick — a GP admits a sparse-precision (SP](../../claims/gaussian-process/C4.md) `0.86`
- [✗ gaussian-process S5 · for a **predictive-process / global-inducing-point GP with a dense des](../../recs/gaussian-process/S5.md) `0.85`
