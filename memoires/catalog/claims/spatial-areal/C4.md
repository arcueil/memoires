...
- [✗ hierarchical-multilevel D3 · for a non-identified hierarchical model where you **predict new groups](../../recs/hierarchical-multilevel/D3.md) `0.82`
- [CC-priors-identifiability C6 · The device you use to *break* a non-identifiability is itself a modeli](../../claims/CC-priors-identifiability/C6.md) `0.82`
- [CC-geometry-sampling C1 · Geometry belongs to the *model*, not the sampler — knobs and hardware ](../../claims/CC-geometry-sampling/C1.md) `0.81`
