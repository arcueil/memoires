...
- [✗ CC-priors-identifiability P3 · when **you assume randomization alone suppresses confounding** → does ](../../recs/CC-priors-identifiability/P3.md) `0.81`
- [CC-priors-identifiability C7 · Parameters are "polite fictions"; linking a posterior to a population ](../../claims/CC-priors-identifiability/C7.md) `0.77`
- [✓ regression TB1 · for a **limited / corner outcome piled at a bound** (expenditure, hour](../../recs/regression/TB1.md) `0.77`
