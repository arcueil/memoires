...
- [ode-dynamical C2 · Bayesian inference through an ODE likelihood: per-iteration cost is pa](../../claims/ode-dynamical/C2.md) `0.81`
- [✗ CC-priors-identifiability P1 · when **a committed subjective Bayesian refuses the known sampling mech](../../recs/CC-priors-identifiability/P1.md) `0.81`
- [sparse-shrinkage C1 · Bayesian sparsity is posterior concentration, not selection — so it al](../../claims/sparse-shrinkage/C1.md) `0.81`
