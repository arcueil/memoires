...
- [✓ regression CF2 · for a variate–covariate model with **no confounding parameter** → **dr](../../recs/regression/CF2.md) `0.77`
- [✗ regression DG1 · for **nonlinearly-correlated component covariates** → reading **curvat](../../recs/regression/DG1.md) `0.77`
