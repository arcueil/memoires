...
- [✓ regression CF2 · for a variate–covariate model with **no confounding parameter** → **dr](../../recs/regression/CF2.md) `0.83`
- [✓ CC-model-evaluation E8 · when a **COVARIATE is missing** → **imputing it** (joint submodel) wor](../../recs/CC-model-evaluation/E8.md) `0.82`
- [regression C1 · Regression is a narrow special case of variate–covariate modeling — co](../../claims/regression/C1.md) `0.82`
- [✗ regression CF4 · for **detecting** confounding / marginal-covariate-model failure → a *](../../recs/regression/CF4.md) `0.80`
