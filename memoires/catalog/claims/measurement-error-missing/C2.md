...
- [✗ regression CF5 · for a **randomized/designed experiment with dropout/censoring** correl](../../recs/regression/CF5.md) `0.86`
- [✓ regression CF2 · for a variate–covariate model with **no confounding parameter** → **dr](../../recs/regression/CF2.md) `0.79`
- [✗ CC-priors-identifiability K3 · when **you fix a random-effect correlation to zero** (brms `||`, lkj-a](../../recs/CC-priors-identifiability/K3.md) `0.78`
