...
- [CC-model-evaluation C7 · The evaluation apparatus is itself fallible — diagnostics are noisy Mo](../../claims/CC-model-evaluation/C7.md) `0.84`
- [CC-geometry-sampling C8 · The VI approximating family sets the uncertainty structure — mean-fiel](../../claims/CC-geometry-sampling/C8.md) `0.81`
- [✓ CC-geometry-sampling VI1 · when you want faster, more stable VI convergence than stochastic ADVI ](../../recs/CC-geometry-sampling/VI1.md) `0.81`
