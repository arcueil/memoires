...
- [✗ sparse-shrinkage W4 · for a **chain that never satisfies the MCMC CLT** → **warmup** does **](../../recs/sparse-shrinkage/W4.md) `0.84`
- [✗ gaussian-process W2 · for a **chain that was never converging** → **warmup** does **NOT** re](../../recs/gaussian-process/W2.md) `0.83`
- [✗ CC-geometry-sampling DV9 · when a chain **freezes intermittently in a funnel neck** (sticky excur](../../recs/CC-geometry-sampling/DV9.md) `0.81`
