...
- [✓ CC-model-evaluation G5 · when you have **per-observation REs** → **integrating out the RE** (co](../../recs/CC-model-evaluation/G5.md) `0.82`
- [CC-priors-identifiability C7 · Parameters are "polite fictions"; linking a posterior to a population ](../../claims/CC-priors-identifiability/C7.md) `0.82`
