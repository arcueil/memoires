...
- [gaussian-process C2 · The GP latent field is a high-dimensional funnel — whiten it (NCP Chol](../../claims/gaussian-process/C2.md) `0.90`
- [✓ gaussian-process G3 · for a **latent-Gaussian model** y = Au + ε, u ~ N(0,Q(θ)⁻¹) → **margin](../../recs/gaussian-process/G3.md) `0.87`
- [✓ regression GP1 · for a **latent-Gaussian (GP) regression with divergences at small σ** ](../../recs/regression/GP1.md) `0.86`
- [✓ gaussian-process G5 · for an **NCP GP with a Gaussian likelihood linear in the latent** → a ](../../recs/gaussian-process/G5.md) `0.85`
