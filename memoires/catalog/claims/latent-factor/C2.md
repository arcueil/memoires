...
- [✗ CC-priors-identifiability S8 · when **an observable is the SUM of ≥2 free latent additive components*](../../recs/CC-priors-identifiability/S8.md) `0.92`
- [time-series-state-space C6 · A structural time series decomposes additively into interpretable late](../../claims/time-series-state-space/C6.md) `0.81`
...
- [✗ gaussian-process A1 · for an **additive / multi-component signal decomposition** (multi-scal](../../recs/gaussian-process/A1.md) `0.80`
