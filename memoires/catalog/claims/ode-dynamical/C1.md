...
- [✗ CC-geometry-sampling IM10 · when a **CNF's vector field f is constrained only at the two endpoints](../../recs/CC-geometry-sampling/IM10.md) `0.77`
- [✗ CC-geometry-sampling DM9 · when the generative model has **hard partitions / threshold splits** (](../../recs/CC-geometry-sampling/DM9.md) `0.75`
