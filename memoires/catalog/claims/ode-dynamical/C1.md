...
- [✓ CC-geometry-sampling IM9 · when you need **both the forward (training) and reverse (sampling) map](../../recs/CC-geometry-sampling/IM9.md) `0.83`
- [✗ CC-geometry-sampling IM10 · when a **CNF's vector field f is constrained only at the two endpoints](../../recs/CC-geometry-sampling/IM10.md) `0.76`
...
- [gaussian-process C4 · Sparsity is not a numerical trick — a GP admits a sparse-precision (SP](../../claims/gaussian-process/C4.md) `0.75`
