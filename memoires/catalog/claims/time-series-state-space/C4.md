...
- [CC-geometry-sampling C2 · Divergences are read by *location* and *origin*, not count — and their](../../claims/CC-geometry-sampling/C2.md) `0.89`
...
- [✗ CC-geometry-sampling DV1 · when divergences appear on a hierarchical/scale model → treating them ](../../recs/CC-geometry-sampling/DV1.md) `0.86`
