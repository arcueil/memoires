...
- [✗ hierarchical-multilevel J1 · for **minibatch/stochastic VI** (SVI/ADVI) → treating it like frequent](../../recs/hierarchical-multilevel/J1.md) `0.95`
- [✓ hierarchical-multilevel J2 · for **minibatch VI** → apply the **N/b correction** to all subsampled ](../../recs/hierarchical-multilevel/J2.md) `0.90`
- [✗ CC-convergence-diagnostics J1 · when you read an oscillating / spiking ELBO curve as a bug or a bad va](../../recs/CC-convergence-diagnostics/J1.md) `0.81`
