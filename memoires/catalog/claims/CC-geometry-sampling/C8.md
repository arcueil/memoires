...
- [CC-model-evaluation C7 · The evaluation apparatus is itself fallible — diagnostics are noisy Mo](../../claims/CC-model-evaluation/C7.md) `0.80`
...
- [spatial-areal C2 · The GMRF precision parameterization silently decouples its scalar τ fr](../../claims/spatial-areal/C2.md) `0.80`
