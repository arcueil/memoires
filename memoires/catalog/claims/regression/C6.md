...
- [CC-model-evaluation C6 · Hypothesis tests and single-number summaries (Bayes factors, R², varia](../../claims/CC-model-evaluation/C6.md) `0.78`
- [measurement-error-missing C3 · The Bayesian repair for non-ignorable selection is to model the random](../../claims/measurement-error-missing/C3.md) `0.77`
- [✗ CC-model-evaluation H1 · when computing a **Bayes factor on an estimation-prior fit** (e.g. rst](../../recs/CC-model-evaluation/H1.md) `0.77`
