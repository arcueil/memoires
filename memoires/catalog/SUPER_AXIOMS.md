...
*7 grand principles over the 88 mid-level claims (6 data-clustered from the original 76 + SA7 added when the pymc-labs merge supplied sources for the workflow/elicitation gap). Each subsumes a cluster of mid-level claims below it.*
...
- [spatial-areal C6](claims/spatial-areal/C6.md) · Spatial structure is a substantive commitment derived from the data's
...
- [hierarchical-multilevel C6](claims/hierarchical-multilevel/C6.md) · Minibatch VI must rescale every subsampled term by N/b, or the ELBO is
