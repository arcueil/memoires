export const meta = {
  ...
  description: 'Re-read each source post and extract claim-level knowledge: 0..N claims + 0..M reusable techniques, with a seriousness assessment',
  ...
  properties: {
    ...
    post_assessment: {
      ...
      properties: {
        ...
        seriousness: { type: 'string', enum: ['high', 'medium', 'low'] },
        note: { type: 'string' },
      },
    },
...
- a NOT-SERIOUS / non-rigorous post: say so (seriousness: low) and extract cautiously (or nothing).
...
Return ONLY: {slug:"${slug}", source, post_assessment:{type, seriousness, note}, claims:[...], techniques:[...]}.`
}
