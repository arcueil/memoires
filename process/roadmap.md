...
- [x] `memoires[semantic]`: embedding search over entries (precomputed vectors shipped;
...
- [x] L2 embedding index over *full entry bodies + sources* (not just headlines) — the
